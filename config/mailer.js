...
async function createMailTransporter (user) {
    ...
    let info = await transporter.sendMail({
        ...
        <a href='${process.env.CLIENT_URL}/verify/${user.verify_code}' style="display:inline-block;width:100%;font-family:Arial,Helvetica,sans-serif;font-size:16px;font-weight:bold;line-height:19px;color:#ffffff;text-align:center;text-decoration:none;background-color:#161616;border-radius:14px;border-top:12px solid #161616;border-bottom:12px solid #161616;text-transform:uppercase" target="_blank" data-saferedirecturl="http://localhost:3000/verify/4ffbcdd6f1c0a35bd89e">
        &nbsp;&nbsp;CONFIRM EMAIL
        &nbsp;&nbsp;
        </a>
        </td>

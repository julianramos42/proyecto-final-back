        ...
        <body>
          <div style="margin:0;padding:0;display: flex;justify-content:center;align-items: center;" width="100%">
                    <div style="width:614px;background-color:#F4F4F2;height:730px;">
                        ...
                        <div style="position:absolute;width:433px;height:487px;left:50%;top:60%;transform:translate(-50%,-50%);overflow:hidden;background-color: white;border-radius: 8px;box-shadow:0px 4px 4px rgba(0, 0, 0, 0.25); ;">
